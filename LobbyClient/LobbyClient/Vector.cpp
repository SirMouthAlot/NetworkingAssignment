...
std::ostream& operator<<(std::ostream& out, const Vector3CS& vec)
{
	out << "Vector3: ";
...
Vector3CS::Vector3CS(float _x, float _y, float _z)
{
	x = _x;
	y = _y;
	z = _z;
...
Vector3CS::Vector3CS(float _x, float _y)
{
	x = _x;
	y = _y;
	z = 0.0f;
